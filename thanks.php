...
<?php require('inc/nav.php'); ?>
    <div class="description-content">
            <div class="description-produit">
                ...
                <div class="text">
                <h3>Team and Contributors</h3>
                    <p>Thanks to all the <strong>shutuptrackers.com</strong> contributors who helped in one way or another with the creation of the site.</p>
                </div>
                <span></span>
            </div>
        </div>
