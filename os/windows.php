...
<?php require __DIR__ . "/../inc/nav.php"; ?>
        ...
        <h1 class="title_pres">Windows - A privacy nightmare</h1>
        <p class="desc_article">
        Microsoft just can't seem to shake the image that Windows is spying on you. And Microsoft's lack of transparency about Windows's privacy isn't doing much to dispel the notion.<br>
        At Windows's release, there have been numerous reports about how much personal information Microsoft collects.<br>
        </p>
        <h3 class="title_desc" id="sharing">1 - Shares your personal information with Microsoft by default</h3>
        <p class="desc_article">
        By default, Windows shares a lot of information about you with Microsoft.
        According to the company's <a href="https://privacy.microsoft.com/en-us/privacystatement">privacy policy</a>, Windows sends Microsoft everything you say to Cortana, Windows' Siri-like virtual assistant.
        ...
        <p class="desc_article">
        Windows will use your Internet connection to help other people download apps or update their computers.<br><br>
        ...
        <ul class="list_article">
            ...
            <li>2 - Select <strong>Delivery Optimization</strong> (or <strong>Choose how updates are delivered</strong> in earlier versions of Windows).</li>
        ...
        <p class="desc_article">When downloading Windows, you are authorizing Microsoft to share any of above-mentioned data with any third-party, with or without your consent.<br>
        ...
        <p class="desc_article">The Windows license agreement everyone agrees to (without reading) includes language that seems to allow the company to scan your computer for pirated games and disable them at will.<br>
        ...
        <p class="desc_article">
        You can use as many tools and disable as many options as you want Windows will always spy on you. The best way to avoid this is not to use Windows.<br>
        ...
        <p class="desc_article">
        DisableWinTracking is a helpful tool for privacy-concerned users to disable a part of the native tracking within Windows, exemple :<br><br>
        If you leave your machine for 8 hours, inactive Windows will send more than <code>5,500 connections to 93 different IP addresses</code>, including nearly <code> 4,000 to 51 different IP addresses </code> belonging to Microsoft.<br>

        If you leave the machine for 30 hours, Windows has extended this connection to <code>113 non-private IP addresses</code>, potentially allowing hackers to intercept this data.<br>
        ...
        <h4 id="tools"><strong>Overview of Windows Privacy Tools :</strong></h4>
        <br>
        <table class="table_os">
            ...
            <tr>
                <td><a href="https://christitus.com/windows-tool/" target="_blank">The Ultimate Windows Utility</a></td>
                <td>No / No</td>
                <td>Disable Services, Telemetry, Privacy</td>
                <td>No </td>
            </tr>
            </tbody>
        </table>
