  ...
  <ul class="cards">
    ...
    <div class="card">
        ...
        <div class="circle">
          ...
          <button class="btn card_btn" onclick="window.location.href = 'https://nextcloud.com/'">Read More</button>
        </div>
      </div>
    </li>
    <li class="cards_item">
    <div class="card">
        ...
        <div class="circle">
          ...
          <button class="btn card_btn" onclick="window.location.href = 'https://www.etesync.com/'">Read More</button>
        </div>
      </div>
    </li>
    <li class="cards_item">
    <div class="card">
        ...
        <div class="circle">
          ...
          <button class="btn card_btn" onclick="window.location.href = 'https://beta.protonmail.com/calendar'">Read More</button>
        </div>
      </div>
    </li>
    </ul>
